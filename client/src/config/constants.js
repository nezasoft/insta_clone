...
export const NEW_PWD_URL =`http://localhost:5000/new_pwd`;
//Profile screen
export const MY_POST_URL =`http://localhost:5000/mypost`;
export const MY_BOOKMARKS_PWD_URL =`http://localhost:5000/bookmarks`;

//Reset password screen
export const RESET_PWD_URL =`http://localhost:5000/reset_pwd`;
//Sign up screen
export const SIGNUP_URL =`http://localhost:5000/signup`;

//Subscribe Posts
export const SUB_POST_URL =`http://localhost:5000/subbost`;
