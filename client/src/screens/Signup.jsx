...
const Signup = () => {
    ...
    const handlePostData = () =>{
        //Here we check if the email supplied is valid or has the correct format
        if(EmailRegex.test(email)){
            axios.post(SIGNUP_URL,{name,password,email,})
            .then((res)=>{
                const data = res.data;
                if(data.error){
                    ...
                    //set timeout before redirecting the user to login page
